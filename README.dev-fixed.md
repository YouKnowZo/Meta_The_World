...
- Install Node.js LTS 18.x. Recommended: [Node.js download page](https://nodejs.org/en/download/)
...
Recent Lerna versions (v7+) removed the `bootstrap` command. If you were following older docs that use `npx lerna bootstrap`, replace that step with `npm install` (or your package manager's workspace install). If you specifically need legacy `bootstrap` behavior, install Lerna v6 globally or in devDependencies:
